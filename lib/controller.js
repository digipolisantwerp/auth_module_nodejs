...
module.exports = function createController(config) {
  ...
  function createLoginUrl(host, serviceName, key, lng) {
    ...
    if (serviceProvider.version === 'v2') {
      ...
      query.auth_methods = serviceProvider.authMethods;
  ...
  function logoutCallback(req, res) {
    ...
    console.log('req.query.state: ', state); // TODO: remove me
    console.log('logoutState: ', logoutState); // TODO: remove me
    console.log('session 1: ', req.session); // TODO: remove me
    ...
    console.log('session 2: ', req.session); // TODO: remove me
    const key = config.serviceProviders[serviceName].key || 'user';
    
    async.series(hooks, () => {
      console.log('session 2: ', req.session); // TODO: remove me
      console.log('key: ', key); // TODO: remove me
